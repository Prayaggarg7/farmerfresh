angular.module("myapp",['ui.bootstrap'])
	...
	$scope.addNewCrop = function () {
        console.log('working');
        var newItemNo = {'id':$scope.myForm.data.length+1, 'crop_name':'', 'crop_month':''};
    ...
    $scope.addNewCrop();
        $scope.submitTheForm=function(item,event){
            ...
            var dataObject={
                ...
                land_area:$scope.myForm.land_area,
            ...
            /*if(captcha === ""){ //if string is empty
                alert("Please resolve the captcha and submit!")
                
            }else {
                var responsePromise=$http.post("http://api.crofarm.com/farmers/v1/",dataObject,{});
